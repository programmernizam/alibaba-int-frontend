...
import { confirmInvoicePayment, getInvoice } from "../../utils/Services";
                  ...
                  <div className='card-body'>
                    <table className='table table table-cart'>
                      ...
                      <tfoot>
                        <tr>
                          <td colSpan={3}>
                            <h3 className='binvoice-0 m-0 py-3 summary-title'>Invoice Total Summary</h3>
                          </td>
                        </tr>
...
export default connect(mapStateToProps, {})(withRouter(PayByInvoice));
